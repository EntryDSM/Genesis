...
export const setStartScheduleMonth = createAction(START_SCHEDULE_MONTH)<string>();
export const setStartScheduleDay = createAction(START_SCHEDULE_DAY)<string>();
export const setStartScheduleHour = createAction(START_SCHEDULE_HOUR)<string>();
export const setStartScheduleMinute = createAction(START_SCHEDULE_MINUTE)<string>();
export const setStartScheduleSecond = createAction(START_SCHEDULE_SECOND)<string>();
export const setEndScheduleMonth = createAction(END_SCHEDULE_MONTH)<string>();
export const setEndScheduleDay = createAction(END_SCHEDULE_DAY)<string>();
export const setEndScheduleHour = createAction(END_SCHEDULE_HOUR)<string>();
export const setEndScheduleMinute = createAction(END_SCHEDULE_MINUTE)<string>();
export const setEndScheduleSecond = createAction(END_SCHEDULE_SECOND)<string>();
export const setFirstScheduleMonth = createAction(FIRST_SCHEDULE_MONTH)<string>();
export const setFirstScheduleDay = createAction(FIRST_SCHEDULE_DAY)<string>();
export const setFirstScheduleHour = createAction(FIRST_SCHEDULE_HOUR)<string>();
export const setFirstScheduleMinute = createAction(FIRST_SCHEDULE_MINUTE)<string>();
export const setFirstScheduleSecond = createAction(FIRST_SCHEDULE_SECOND)<string>();
export const setInterviewScheduleMonth = createAction(INTERVIEW_SCHEDULE_MONTH)<string>();
export const setInterviewScheduleDay = createAction(INTERVIEW_SCHEDULE_DAY)<string>();
export const setInterviewScheduleHour = createAction(INTERVIEW_SCHEDULE_HOUR)<string>();
export const setInterviewScheduleMinute = createAction(INTERVIEW_SCHEDULE_MINUTE)<string>();
export const setInterviewScheduleSecond = createAction(INTERVIEW_SCHEDULE_SECOND)<string>();
export const setSecondScheduleMonth = createAction(SECOND_SCHEDULE_MONTH)<string>();
export const setSecondScheduleDay = createAction(SECOND_SCHEDULE_DAY)<string>();
export const setSecondScheduleHour = createAction(SECOND_SCHEDULE_HOUR)<string>();
export const setSecondScheduleMinute = createAction(SECOND_SCHEDULE_MINUTE)<string>();
export const setSecondScheduleSecond = createAction(SECOND_SCHEDULE_SECOND)<string>();
