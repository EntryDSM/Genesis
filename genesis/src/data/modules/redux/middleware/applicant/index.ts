...
import {
  ...
  updateApplicantPaidStatusApi,
  updateApplicantSubmitStatusApi,
  checkPasswordApi,
  deleteApplicantTableApi,
...
} from "src/data/modules/redux/action/applicant/interface";

export const getApplicantListSaga = createRequestSaga(
  GET_APPLICANTS_LIST,
  getApplicantsListApi
);
export const getApplicantInfoSaga = createRequestSaga(
  GET_APPLICANT_INFO,
  getApplicantInfoApi
);
export const updateApplicantStatusSaga = createRequestSaga(
  UPDATE_APPLICANT_STATUS,
  updateApplicantStatusApi
);
export const updateApplicantPaidStatusSaga = createRequestSaga(
  UPDATE_APPLICANT_PAID_STATUS,
  updateApplicantPaidStatusApi
);
export const updateApplicantSubmitStatusSaga = createRequestSaga(
  UPDATE_APPLICANT_SUBMIT_STATUS,
  updateApplicantSubmitStatusApi
);
export const deleteApplicantTableSaga = createRequestSaga(
  DELETE_APPLICANT_TABLE,
  deleteApplicantTableApi
);
...
function* applicantSaga() {
  ...
  yield takeLatest(
    UPDATE_APPLICANT_SUBMIT_STATUS,
    updateApplicantSubmitStatusSaga
  );
