...
export const UPDATE_APPLICANT_PAID_STATUS = 'applicant/UPDATE_APPLICANT_PAID_STATUS' as const;
export const UPDATE_APPLICANT_PAID_STATUS_SUCCESS = 'applicant/UPDATE_APPLICANT_PAID_STATUS_SUCCESS' as const;
export const UPDATE_APPLICANT_PAID_STATUS_FAILURE = 'applicant/UPDATE_APPLICANT_PAID_STATUS_FAILURE' as const;
